...
<script src="https://cdn.jotfor.ms/static/jotform.forms.js?3.3.997" type="text/javascript"></script>
        ...
        <input type="text" id="input_4" name="sleeper" data-type="input-textbox" class="form-textbox" size="20"  data-component="textbox" value="<?php echo $votes->getVote($voter, 'sleeper'); ?>" required />
        </div>
        </li>
        <li class="form-line" data-type="control_textbox" id="id_5">
        <label class="form-label form-label-left form-label-auto" id="label_5" for="input_5"> The thinker </label>
        <div id="cid_5" class="form-input jf-required">
        <input type="text" id="input_5" name="thinker" data-type="input-textbox" class="form-textbox" size="20"  data-component="textbox" value="<?php echo $votes->getVote($voter, 'thinker'); ?>"/>
        </div>
        </li>
        ...
        <input type="text" id="input_6" name="solution" data-type="input-textbox" class="form-textbox" size="20"  data-component="textbox" value="<?php echo $votes->getVote($voter, 'solution'); ?>"/>
        </div>
        </li>
        ...
        <input type="text" id="input_7" name="energy" data-type="input-textbox" class="form-textbox" size="20"  data-component="textbox" value="<?php echo $votes->getVote($voter, 'energy'); ?>"/>
        </div>
        </li>
        ...
        <input type="text" id="input_8" name="team" data-type="input-textbox" class="form-textbox" size="20"  data-component="textbox" value="<?php echo $votes->getVote($voter, 'team'); ?>"/>
        </div>
        </li>
        ...
        <input type="text" id="input_9" name="serious" data-type="input-textbox" class="form-textbox" size="20"  data-component="textbox" value="<?php echo $votes->getVote($voter, 'serious'); ?>"/>
        </div>
        </li>
        ...
        <input type="text" id="input_10" name="beautiful" data-type="input-textbox" class="form-textbox" size="20"  data-component="textbox" value="<?php echo $votes->getVote($voter, 'beautiful'); ?>"/>
        </div>
        </li>
        ...
        <input type="text" id="input_11" name="coffee" data-type="input-textbox" class="form-textbox" size="20"  data-component="textbox" value="<?php echo $votes->getVote($voter, 'coffee'); ?>"/>
        </div>
        </li>
        ...
        <input type="text" id="input_12" name="player" data-type="input-textbox" class="form-textbox" size="20"  data-component="textbox" value="<?php echo $votes->getVote($voter, 'player'); ?>"/>
        </div>
        </li>
        ...
        <input type="text" id="input_13" name="hard" data-type="input-textbox" class="form-textbox" size="20"  data-component="textbox" value="<?php echo $votes->getVote($voter, 'hard'); ?>"/>
        </div>
        </li>
        ...
        <input type="text" id="input_14" name="active" data-type="input-textbox" class="form-textbox" size="20" data-component="textbox" value="<?php echo $votes->getVote($voter, 'active'); ?>"/>
        </div>
        </li>
