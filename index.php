...
<div class="alert fade in alert-success alert-dismissable" id="notification"><button aria-hidden="true" class="close" data-dismiss="alert" type="button"></button>You successfully updated your prefferences for the wall of fame!</div>';
    if ($_GET['error'] == TRUE)
        echo '
<div class="alert fade in alert-danger alert-dismissable" id="notification"><button aria-hidden="true" class="close" data-dismiss="alert" type="button"></button>We couldn\'t find some of the users. Please ensure that you only enter their login!</div>';
?>
<html class="supernova"><head>
<meta http-equiv="Content-Type" content="text/html; charset=utf-8" />
<link rel="alternate" type="application/json+oembed" href="https://www.jotform.com/oembed/?format=json&amp;url=http%3A%2F%2Fwww.jotform.com%2Fform%2F71945133996367" title="oEmbed Form"><link rel="alternate" type="text/xml+oembed" href="https://www.jotform.com/oembed/?format=xml&amp;url=http%3A%2F%2Fwww.jotform.com%2Fform%2F71945133996367" title="oEmbed Form">
<meta property="og:title" content="The best POOLers" >
<meta property="og:url" content="http://www.jotformeu.com/form/71945133996367" >
...
<script src="https://cdn.jotfor.ms/static/jotform.forms.js?3.3.997" type="text/javascript"></script>
        ...
        <body>
        <form class="jotform-form" action="update.php" method="post" name="vote" id="71945133996367" accept-charset="utf-8">
        <input type="hidden" name="formID" value="71945133996367" />
        <div class="form-all">
        ...
        <select name="sleeper">
            <option value="abaltare">abaltare</option>
            <option value="aberar">aberar</option>
            <option value="abidian">abidian</option>
            <option value="abiz">abiz</option>
            <option value="abungiac">abungiac</option>
            <option value="acatargi">acatargi</option>
            <option value="adanciu">adanciu</option>
            <option value="ade-giov">ade-giov</option>
            <option value="adeac">adeac</option>
            <option value="adimitri">adimitri</option>
            <option value="adobrito">adobrito</option>
            <option value="adpopa">adpopa</option>
            <option value="adripop">adripop</option>
            <option value="adrpop">adrpop</option>
            <option value="adsabau">adsabau</option>
            <option value="adstanci">adstanci</option>
            <option value="ahuzmeza">ahuzmeza</option>
            <option value="aiurii">aiurii</option>
            <option value="aiusan">aiusan</option>
            <option value="alablai">alablai</option>
            <option value="alcamara">alcamara</option>
            <option value="alchira">alchira</option>
            <option value="allaza">allaza</option>
            <option value="anbanc">anbanc</option>
            <option value="aracz">aracz</option>
            <option value="asas-mir">asas-mir</option>
            <option value="asoptere">asoptere</option>
            <option value="astef">astef</option>
            <option value="astoica">astoica</option>
            <option value="atirtan">atirtan</option>
            <option value="avaida">avaida</option>
            <option value="bacsanei">bacsanei</option>
            <option value="bavram">bavram</option>
            <option value="bcalin">bcalin</option>
            <option value="bravas">bravas</option>
            <option value="candries">candries</option>
            <option value="cbaias">cbaias</option>
            <option value="cbutiu">cbutiu</option>
            <option value="ccalin-a">ccalin-a</option>
            <option value="cceremec">cceremec</option>
            <option value="ccraciun">ccraciun</option>
            <option value="cleonte">cleonte</option>
            <option value="cmacarie">cmacarie</option>
            <option value="cmoldova">cmoldova</option>
            <option value="crperijo">crperijo</option>
            <option value="csoptere">csoptere</option>
            <option value="ctimaru">ctimaru</option>
            <option value="cutu">cutu</option>
            <option value="czegrean">czegrean</option>
            <option value="dbaltag">dbaltag</option>
            <option value="ddragos">ddragos</option>
            <option value="dneag">dneag</option>
            <option value="dnedelcu">dnedelcu</option>
            <option value="dpodar">dpodar</option>
            <option value="draducu">draducu</option>
            <option value="dvandici">dvandici</option>
            <option value="dvarga">dvarga</option>
            <option value="ebogdan">ebogdan</option>
            <option value="eene">eene</option>
            <option value="elazar">elazar</option>
            <option value="ezosim">ezosim</option>
            <option value="flupsa">flupsa</option>
            <option value="gpop">gpop</option>
            <option value="gsidor">gsidor</option>
            <option value="hconstan">hconstan</option>
            <option value="ibakos">ibakos</option>
            <option value="ibiz">ibiz</option>
            <option value="ibusuioc">ibusuioc</option>
            <option value="iclapou">iclapou</option>
            <option value="iistrati">iistrati</option>
            <option value="imailat">imailat</option>
            <option value="itrandaf">itrandaf</option>
            <option value="jeke">jeke</option>
            <option value="khenzule">khenzule</option>
            <option value="lbratu">lbratu</option>
            <option value="lroland">lroland</option>
            <option value="lstoica">lstoica</option>
            <option value="mapopa">mapopa</option>
            <option value="mausan">mausan</option>
            <option value="mbadea">mbadea</option>
            <option value="mbogdan">mbogdan</option>
            <option value="mhotea">mhotea</option>
            <option value="mpodina">mpodina</option>
            <option value="mradu">mradu</option>
            <option value="mraul-io">mraul-io</option>
            <option value="mtudor">mtudor</option>
            <option value="mvintila">mvintila</option>
            <option value="ndomide">ndomide</option>
            <option value="nosan">nosan</option>
            <option value="npal">npal</option>
            <option value="ogherman">ogherman</option>
            <option value="pandor">pandor</option>
            <option value="pandrei-">pandrei-</option>
            <option value="pbumbu">pbumbu</option>
            <option value="pcoman">pcoman</option>
            <option value="ralutsch">ralutsch</option>
            <option value="rbrasfel">rbrasfel</option>
            <option value="rbucur">rbucur</option>
            <option value="rbudacan">rbudacan</option>
            <option value="rdarmon">rdarmon</option>
            <option value="rfloresc">rfloresc</option>
            <option value="rmigea">rmigea</option>
            <option value="rmuresan">rmuresan</option>
            <option value="rpasc">rpasc</option>
            <option value="rpaul-va">rpaul-va</option>
            <option value="rtivda">rtivda</option>
            <option value="rtrif">rtrif</option>
            <option value="sbobotan">sbobotan</option>
            <option value="scoman">scoman</option>
            <option value="silea">silea</option>
            <option value="snegoesc">snegoesc</option>
            <option value="sstasii">sstasii</option>
            <option value="tbratan">tbratan</option>
            <option value="temoisi">temoisi</option>
            <option value="tgruian">tgruian</option>
            <option value="tiboth">tiboth</option>
            <option value="tpasca">tpasca</option>
            <option value="tradu">tradu</option>
            <option value="trussu">trussu</option>
            <option value="vfenesan">vfenesan</option>
            <option value="vlzait">vlzait</option>
            <option value="vmuresan">vmuresan</option>
            <option value="vsabau-m">vsabau-m</option>
            <option value="ztasnadi">ztasnadi</option>
        </select>
        </div>
        </li>
